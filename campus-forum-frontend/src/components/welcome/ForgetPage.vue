      ...
      <div>
        <div style="text-align: center;margin: 0 20px;height: 100%" v-if="active === 0">
          <div style="margin-top: 80px">
            ...
            <div style="font-size: 14px;color: grey;margin-top: 10px">请输入需要重置密码的电子邮件地址</div>
          </div>
    ...
    <transition name="el-fade-in-linear" mode="out-in">
      <div style="text-align: center;margin: 0 20px;height: 100%" v-if="active === 1">
        <div style="margin-top: 100px">
          <div style="font-size: 25px; font-weight: bold">重置密码</div>
          <div style="font-size: 14px;color: grey;margin-top: 10px">请输入重新设定的密码，务必牢记，防止丢失</div>
        </div>
        <el-form style="margin-top: 50px" :model="form" :rules="rules" @validate="onValidate" ref="formRef">
          ...
          <el-form-item prop="password_repeat">
            <el-input type="password" :prefix-icon="Lock" :maxlength="16" v-model="form.password_repeat" placeholder="重复新密码" show-password/>
          </el-form-item>
        </el-form>
        <div style="margin-top: 40px">
